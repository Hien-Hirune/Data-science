"""
    ...
    Example:
        python3 impute.py hawks.csv --method=Means --columns Wing Weight Culmen Hallux StandardTail KeelFat Crop --output=hawks_output.csv
"""
...
def FillMissingData(method, columns):
    ...
    if ((method == "means" or method == "median") and type == 3):
        print("Type of " + columns + "is nominal. Using method MODE to fill missing data")
        return
